...
namespace Buku_Resep.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        protected SplitPage rootPage = null;
        ...
        /// </summary>
        protected FrameworkElement firstPage = null;
        ...
        protected virtual void PrintTaskRequested(PrintManager sender, PrintTaskRequestedEventArgs e)
        {
            ...
            printTask = e.Request.CreatePrintTask("Buku Resep", sourceRequested =>
                {
        ...
        protected virtual void CreatePrintPreviewPages(object sender, PaginateEventArgs e)
        {
           ...
           // catch (Exception) {}
            ...
            RichTextBlockOverflow lastRTBOOnPage = new RichTextBlockOverflow();
        ...
        protected virtual RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            Grid printableArea = (Grid)page.FindName("itemDetailGrid");

            // Get the margins size
            // If the ImageableRect is smaller than the app provided margins use the ImageableRect
            double marginWidth = Math.Max(printPageDescription.PageSize.Width - printPageDescription.ImageableRect.Width, printPageDescription.PageSize.Width * ApplicationContentMarginLeft * 3);
            double marginHeight = Math.Max(printPageDescription.PageSize.Height - printPageDescription.ImageableRect.Height, printPageDescription.PageSize.Height * ApplicationContentMarginTop * 3);
